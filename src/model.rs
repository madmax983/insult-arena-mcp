//! Domain models and data structures for the Insult Arena.
//!
//! This module contains pure data types that are shared across the application.
//! It acts as the "Ubiquitous Language" of the domain.

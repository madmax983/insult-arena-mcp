...
const DEFAULT_WINS_NEEDED: u8 = 3;
...
impl Duel {
    ...
    pub const fn new() -> Self {
        Self {
            ...
            challenger_score: 0,
            defender_score: 0,
            wins_needed: DEFAULT_WINS_NEEDED,
            exchanges: Vec::new(),
    ...
    pub fn respond(&mut self, comeback: String) -> Result<Exchange, InsultError> {
        ...
        self.check_victory_or_next_turn(winner);
    ...
    const fn check_victory_or_next_turn(&mut self, winner: Duelist) {
